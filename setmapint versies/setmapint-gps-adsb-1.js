...
function adsbapi(){
  //getting current maxAltitude from the slider
  var slider = document.getElementById("maxAltitudeSlider");

slider.addEventListener('input', updateMaxAltitude)

  function updateMaxAltitude(e){
    maximumAltitude = slider.value
  }

  //declaring each variable that is required later
  var maximumAltitude = slider.value //in feet AMSL
