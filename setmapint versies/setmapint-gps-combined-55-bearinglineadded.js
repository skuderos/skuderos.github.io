...
//placing the gpsline
          var gpsLineLayerGroup = L.layerGroup()
...
console.log(latlngcurrentcombinedforgpsline)

latlngforbearing.push(latlngcurrentcombinedforgpsline)
latlngforbearing.push(currentwaypointcoords)
console.log(latlngforbearing)
console.log('above is latlngforcurrentbearing and 1st is combined object')
tonextwaypointline.setLatLngs()
