...
var aeromap = L.tileLayer('http://www.jvfrtilehostingserver.xyz:8080/ehaa_256/{z}/{x}/{y}.png',{crossOrigin: true});

var aerohome = L.tileLayer('http://www.jvfrtilehostingserver.xyz:8080/nl_asp/{z}/{x}/{y}.png',{crossOrigin: true});
...
center: [52.2414287, 6.0524422],
    zoom: 14,
    layers: [thundertransport, aerohome, aeroreporting_points, aeroairports]
});
