...
//placing the marker with a custom rotation
  ...
  map.addLayer(gpsMarkerLayerGroup)
        window.locationmarker =  L.marker([51.5, -0.09], {icon: aircraftmarkerpng, rotationAngle: 0})
...
console.log('started gpsloop');
  ...
  var latlngcurrent = latitudecurrent+longitudecurrent
...
//updating the current aircraft marker
  locationmarker.setRotationAngle(brgntranslated);
  console.log(brgntranslated)
  locationmarker.setLatLng(latlngcurrent);
