...
var allwaypointsherecut = allwaypointshere[1];

console.log(allwaypointsherecut.length)
console.log(waypointsCompleted)

if(waypointsCompleted > allwaypointsherecut.length){
