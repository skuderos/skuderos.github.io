...
promise.then(function(deviceOrientation) { // Device Orientation Events are supported
  ...
  var gpsloopid = setInterval(gpsloop, 400);
...
var brngrounded = Math.round(brgntranslated);
  ...
  //updating the current aircraft marker
    locationmarker.setRotationAngle(45)
    locationmarker.setLatLng([52.2414287, 6.0524422]);
    console.log("locationmarker should have rotated")
