...
promise.then(function(deviceOrientation) { // Device Orientation Events are supported
  ...
  deviceOrientation.listen(function() {
    ...
    console.log('reached end of compass heading at least');
  ...
  function getCurrentGpsPosition(position) {
        console.log('started function getcurrentgpsposition');
    //get current location
  ...
  var allwaypointshere = window.varwaypointlatlng;
        console.log('grabbed varwaypointlatlng successfully');
  ...
  var longitudewp = currentwaypointcoords.lng;
        ...
        console.log(longitudewp);
        console.log('currenwaypoint lng above');
...
console.log('above is distance to next waypoint in km')
...
brng = toDegrees(brng);
var brgntranslatedtest = (brng + 360) % 360;
console.log(brng);
console.log('above is bearing to next waypoint')
