...
const currentlocationLayerGroup = L.layerGroup()
map.addLayer(currentlocationLayerGroup)

var aircraftMarker = L.marker([latitudecurrent, longitudecurrent], {
    rotationAngle: compassHeadingRounded,
    icon: aircraftmarkerpng
});
currentlocationLayerGroup.addLayer(aircraftMarker);
